...
def replace_middle(input_list):
    ...
    """
    #solution using list slicing but it's not a dynamic solution
    input_list[2:8] = [42, 37]

    #second solution using extend by creating a temp variable(copy of the original list)
    #temp = [0, 3, 6, 9, 12, 15, 18, 21, 24, 27]
    #input_list = temp[0:2]
    #input_list.extend([42, 27])
    #input_list = temp[0:2]
    #input_list.extend([42, 37])
    #input_list.extend(temp[-2:])

    #pass
    """temp = input_list
    beginning_temp = temp[0:2]
    end_temp = temp[-2:]
    input_list = [beginning_temp[0], beginning_temp[1], 42, 37, end_temp[0], end_temp[1]]"""
...
def delete_third_and_seventh(input_list):
    ...
    del input_list[2]
    del input_list[5]
    """ second solution by using list slicing
    input_list[2:3] = []
    input_list[5:6] = []"""
    #pass
